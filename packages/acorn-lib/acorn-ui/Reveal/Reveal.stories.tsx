    ...
    <>
      <Wrap>
        ...
        <p>
          ...
          eget ligula at fringilla. Vestibulum laoreet in libero eu aliquet.
          Vestibulum aliquet orci commodo elit aliquet gravida.
        </p>
      </Wrap>
      <br />
      ...
      <Wrap className="+align-start +narrow">
        <Heading level={Heading.Level.H2}>
          Aligned to the start (Not Centered)
        </Heading>
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut ultrices
          eget ligula at fringilla. Vestibulum laoreet in libero eu aliquet.
